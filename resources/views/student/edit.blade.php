...
<div class="tw-max-w-2xl tw-mx-auto tw-mt-10 tw-bg-white tw-rounded-lg tw-shadow-sm tw-p-6">
    ...
    <form action="{{ isset($student) ? route('student.update', $student->id) : route('student.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="tw-mb-4">
            <label class="tw-block tw-font-semibold tw-mb-1">Student ID</label>
        ...
        <div class="tw-mb-4">
            <label class="tw-block tw-font-semibold tw-mb-1">Name</label>
        ...
        <div class="tw-mb-4">
            <label class="tw-block tw-font-semibold tw-mb-1">Phone Number</label>
        ...
        <div class="tw-mb-4">
            <label class="tw-block tw-font-semibold tw-mb-1">Transcript (PDF)</label>
        ...
        <div class="tw-mb-4">
            <label class="tw-block tw-font-semibold tw-mb-1">Profile Photo (Image)</label>
