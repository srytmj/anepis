...
<div class="tw-max-w-7xl tw-mx-auto tw-mt-10 tw-bg-white tw-rounded-lg tw-shadow-sm tw-p-5">
    ...
    <div class="tw-flex tw-justify-between tw-items-center tw-mb-5">
        <h2 class="tw-text-xl tw-font-semibold">Vacancy List</h2>
        <a href="{{ route('vacancy.create') }}" class="tw-bg-red-600 tw-text-white tw-px-4 tw-py-2 tw-rounded hover:tw-bg-red-700">Tambah Vacancy</a>
    </div>
        ...
        <table id="vacancyTable" class="tw-w-full tw-text-sm tw-border-collapse">
            <thead class="tw-bg-gray-100 tw-text-gray-700">
                <tr>
                    ...
                    <th class="tw-border tw-p-2">Action</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="hover:tw-bg-gray-50">
                    ...
                    <td class="tw-border tw-p-2">
                        <div class="tw-flex tw-gap-2">
                            ...
                            <form action="{{ route('vacancy.destroy', $vac->id) }}" method="POST" onsubmit="return confirm('Yakin hapus vacancy ini?')">
                                @csrf @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="7" class="tw-text-center tw-text-gray-500 tw-py-4">Tidak ada data vacancy</td>
                </tr>
                @endforelse
            </tbody>
        </table>
